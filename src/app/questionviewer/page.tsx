    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="order-2 hidden lg:order-2 lg:col-span-1 lg:block">
            <Card className="sticky top-24">
              <CardHeader className="pb-3 lg:pb-6">
                <h3 className="text-sm font-semibold text-gray-900 lg:text-base dark:text-white">
                  Question Overview
                </h3>
              </CardHeader>
              <CardContent>
                ...
                {/* Submit Button */}
                <Button className="mt-6 w-full" variant="destructive" size="sm">
                  Submit Exam
                </Button>
              </CardContent>
            </Card>{' '}
