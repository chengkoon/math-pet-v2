...
test.describe('Counter functionality', () => {
  ...
  test('should increment counter when plus button is clicked', async ({ page }) => {
  ...
  test('should decrement counter when minus button is clicked', async ({ page }) => {
    // Reset counter first to ensure clean state
    const resetButton = page.locator('button.bg-gray-500');
    await resetButton.click();
  ...
  test('should handle mixed increment and decrement operations', async ({ page }) => {
    // Reset counter first to ensure clean state
    const resetButton = page.locator('button.bg-gray-500');
    await resetButton.click();
